        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="<?php echo base_url(); ?>admin" class="logo">
                    <span class="logo-mini"><b>Vive</b></span>
                    <span class="logo-lg"><b>Vive Communication</b></span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>admin/add_slider"> Add New Slide</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url(); ?>admin/manage_project"> Manage Projects</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/add_category"> Add New Category</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/manage_category"> Manage Categories</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-bank"></i> <span>Client Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>admin/add_client"> Add New Client</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/manage_client"> Manage Clients</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-newspaper-o"></i> <span>Testimonial Manager</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>admin/add_testimonial"> Add New Testimonial</a></li>
                                <li><a href="<?php echo base_url(); ?>admin/manage_testimonial"> Manage Testimonials</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-map-o"></i> <span>Event Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-male"></i> <span>Team Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
            ...
            <footer class="main-footer">
                <strong>Copyright © <a href="<?php echo base_url(); ?>">Vive Communication</a></strong> All Rights Reserved.
            </footer>
            <script>
